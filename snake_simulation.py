...
class Grid:
    ...
    def go(self):
        ...
        while not all([w.trapped for w in self.snakes]):
            ...
            break
# Main program =================================================================
snec = Snake(position = (5, 5), symbol = 'bo', color = 'b', orientation = 'north', length = 12)
snek = Snake(position = (15, 15), symbol = 'ro', color = 'r', orientation = 'south', length = 6)
sneck = Snake(position = (5, 15), symbol = 'go', color = 'g', orientation = 'east', length = 7)
